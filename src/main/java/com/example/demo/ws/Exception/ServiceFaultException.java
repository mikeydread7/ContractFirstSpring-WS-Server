 ...
 *      howTo Example</a> <SOAP-ENV:Envelope xmlns:SOAP-ENV=
 *      "http://schemas.xmlsoap.org/soap/envelope/"> <SOAP-ENV:Header/>
 *      <SOAP-ENV:Body> <SOAP-ENV:Fault> <faultcode>SOAP-ENV:Server</faultcode>
 *      <faultstring>ERROR</faultstring> <detail> <code>NOT_FOUND</code>
 *      <description>some data issue.</description> </detail> </SOAP-ENV:Fault>
